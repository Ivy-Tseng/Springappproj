...
//    		下方為一個JavaScript物件
		var jsonMember = {  //對應到Member.java (JavaBean的field)
			"id": idValue, 	
			"name": nameValue,
			"balance": balanceValue,
			"birthday": birthdayValue
   		}
  		xhr1.setRequestHeader("Content-Type", "application/json");   //application/json是JSON的Content-Type
  		xhr1.send(JSON.stringify(jsonMember));
  		console.log(JSON.stringify(jsonMember));
//   		JSON.stringify(jsonMember) //將JavaScript物件轉成JSON字串
//   		JSON.parse(jsonString) //將JSON字串轉成JavaScript物件
